...
<html lang="en">
  ...
  <body class="authentication">
    <!-- Container start -->
    <div class="container">
      <form action="http://bootstrap.gallery/le-rouge/design/index.html">
            ...
            <div class="login-screen">
              <div class="login-box">
                ...
                <div class="form-group">
                  ...
                  <small id="passwordHelpInline" class="text-muted"> Password must be 8-20 characters long. </small>
                </div>
                ...
                <hr>
                <div class="m-0">
                  <span class="additional-link">Have an account? <a href="login.html" class="btn btn-dark">Login</a>
                  </span>
                </div>
              </div>
            </div>
